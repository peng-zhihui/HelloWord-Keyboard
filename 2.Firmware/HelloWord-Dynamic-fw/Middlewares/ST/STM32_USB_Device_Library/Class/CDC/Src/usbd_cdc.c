...
__ALIGN_BEGIN uint8_t USBD_CDC_CfgDesc[USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END =
    {
        ...
        LOBYTE(CDC_CMD_MAX_PACKET_SIZE),     /* wMaxPacketSize: */
        HIBYTE(CDC_CMD_MAX_PACKET_SIZE),
        0x10,                           /* bInterval: */
        /*---------------------------------------------------------------------------*/
                             ...
                             uint8_t cfgidx)
{
    ...
    /* Open REF IN endpoint */
    USBD_LL_OpenEP(pdev,
                   REF_IN_EP,
                   USBD_EP_TYPE_BULK,
                   pdev->dev_speed == USBD_SPEED_HIGH ? CDC_DATA_IN_PACKET_SIZE
                                                      : CDC_DATA_IN_PACKET_SIZE);

    /* Open REF OUT endpoint */
    USBD_LL_OpenEP(pdev,
                   REF_OUT_EP,
                   USBD_EP_TYPE_BULK,
                   pdev->dev_speed == USBD_SPEED_HIGH ? CDC_DATA_OUT_PACKET_SIZE
                                                      : CDC_DATA_OUT_PACKET_SIZE);
    ...
    } else
    {
        ...
        /* Prepare REF Out endpoint to receive next packet */
        USBD_LL_PrepareReceive(pdev,
                               REF_OUT_EP,
                               hcdc->REF_Rx.Buffer,
                               CDC_DATA_OUT_PACKET_SIZE);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        // ========================================
        //                                  4
        'R', 0, 'E', 0, 'F', 0, 0, 0, 0, 0, 0, 0, 0, 0
        // 26 bPropertyData “REF”
        // ========================================
        //                                  14
