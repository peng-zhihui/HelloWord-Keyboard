...
#define REF_IN_EP                                   0x83  /* EP3 IN: device TX endpoint */
#define REF_OUT_EP                                  0x03  /* EP3 OUT: device RX endpoint */
...
#define CDC_CMD_MAX_PACKET_SIZE                     8   /* Control Endpoint Packet size */
...
typedef struct
{
    ...
    USBD_CDC_EP_HandleTypeDef REF_Rx;
}
